...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/acct<blob>=0xE6B48BE891B1E5A4A7E4B8B0E694B6/CSXNavigationBar'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'acct<blob>=0xE6B48BE891B1E5A4A7E4B8B0E694B6' => '946873595@qq.com' }
  s.source           = { :git => 'https://github.com/acct<blob>=0xE6B48BE891B1E5A4A7E4B8B0E694B6/CSXNavigationBar.git', :tag => s.version.to_s }
